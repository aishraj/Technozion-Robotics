...
<a href="rscalc.php"><font color="#00FF00" size="4">Robosoccer</font>
</a>
...
<table class="absol4" ><tr><td>
      <img src = "./resources/abovelink2.jpg" width="337" height="60"  ><div class="absol7">
    	...
    	<div class = "absol3">
<br>
<form name="data" action="rscalc.php" method="POST">
...
<table class="ll1"><tr>
			...
			No. of Goals &nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type = "text" name="goals" value="" size="4">
			</TD>
			</TR>
<tr></tr>
			<TR> 
			<TD><font color="#DDFFFF">
			No. of Yellow Cards &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type = "text" name="ycard" value="" size="4"></TD>
			</TR>
<tr></tr>
			<tr>
			<td><font color="#DDFFFF">
			No. of Red Cards
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type = "text" name="rcard" value="" size="4"></td>
			</tr>
<tr></tr>
			<TR> 
			<TD><font color="#DDFFFF">
			Wireless/Wired(1.5/1) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type = "text" name="time" value="" size="4"></TD>
			</TR>
<tr></tr><tr></tr>
